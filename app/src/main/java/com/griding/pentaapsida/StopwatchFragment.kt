...
class StopwatchFragment : Fragment() {
    ...
    private fun startTimer()
    {
        ...
        binding.startStopButton.icon = getDrawable(requireContext(), R.drawable.ic_baseline_pause_24)
        timerStarted = true
    }
    ...
    private fun stopTimer()
    {
        ...
        binding.startStopButton.icon = getDrawable(requireContext(), R.drawable.ic_baseline_play_arrow_24)
        timerStarted = false
    }
